...
float avgPower = 12.0;  // Will be updated via Blynk slider (V2)
  // Average between 10W–20W bulb
...
BLYNK_WRITE(V2) {
  avgPower = param.asFloat();  // Get the slider value
}
...
void setup() {
  ...
  lcd.begin(16, 2);
  Blynk.syncVirtual(V2);  // Restore last slider value from cloud
